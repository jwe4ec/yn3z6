# ---------------------------------------------------------------------------- #
# Run Analyses - Reduced Models (Retaining KMTOT Random Effect)
...
impList_contemp <- as.mitml.list(split(imps2$contemp_imps$red_KMTOT_contemp_imps, 
                                       imps2$contemp_imps$red_KMTOT_contemp_imps$imp_num))
impList_lagged <- as.mitml.list(split(imps2$lagged_imps$red_KMTOT_lagged_imps,
                                      imps2$lagged_imps$red_KMTOT_lagged_imps$imp_num))
...
result_itt_red_KMTOT <- list("contemp_meanDSS_wth" = contemp_meanDSS_wth, 
...
save(result_itt_red_KMTOT, file = "./results/result_itt_red_KMTOT.RData")
